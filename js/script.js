...
function showResult(){
    ...
    else if(userScore >1 && userScore<=4){ // if user scored more than 1 and less than equal to 4
        let scoreTag = '<span> Not That Bad 😎, You got <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else if(userScore >4 && userScore<=8){ // if user scored more than 4 and less than equal to 8
